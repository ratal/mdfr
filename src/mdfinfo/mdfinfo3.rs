...
pub fn hd3_parser(rdr: &mut BufReader<&File>, ver: u16) -> (Hd3, i64) {
    ...
    ASCII
        .decode_to(&date, DecoderTrap::Replace, &mut datestr)
        .unwrap();
    ...
    ASCII
        .decode_to(&time, DecoderTrap::Replace, &mut timestr)
        .unwrap();
    ...
    if ver >= 320 {
        ...
        ISO_8859_1
            .decode_to(&time_identifier, DecoderTrap::Replace, &mut ti)
            .unwrap();
