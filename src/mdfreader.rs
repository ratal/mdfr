...
use self::arrow_helpers::{arrow_bit_count, arrow_byte_count, arrow_to_mdf_data_type, Order};
...
impl Mdf {
    ...
    // pub fn export_to_parquet(&self, file_name: &str, compression: Option<&str>) -> ArrowResult<()> {
